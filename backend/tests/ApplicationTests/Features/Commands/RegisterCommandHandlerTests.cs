...
public class RegisterCommandHandlerTests
{
    ...
    public async Task Handle_Should_ReturnFailure_WhenEmailIsNotUnique()
    {
        ...
        var existingUser = new User("Old", "User", command.Email, "hash", "+380000000000");
    ...
    public async Task Handle_Should_ReturnFailure_WhenPhoneIsNotUnique()
    {
        ...
        var existingUserByPhone = new User("Other", "User", "other@test.com", "hash", command.Phone);
    ...
    public async Task Handle_Should_RegisterUser_WhenDataIsUnique()
    {
        ...
        _jwtTokenGeneratorMock.Setup(x => x.GenerateToken(It.IsAny<User>())).Returns("access_token");
